...
export class Settings {
    ...
    // Exports
    public export_csv_encoding!: any;
    ...
    public motions_default_line_numbering!: any;
    ...
    public motions_recommendation_text_mode!: any;
    ...
    public motion_poll_ballot_paper_selection!: any;
    public motion_poll_ballot_paper_number!: number;
    public motion_poll_default_type!: string;
    ...
    public motion_poll_default_backend!: string;

    // Users
    public users_sort_by!: any;
    ...
    public assignment_poll_ballot_paper_selection!: any;
    ...
    public assignment_poll_default_type!: string;
    ...
    public assignment_poll_default_backend!: string;
}
